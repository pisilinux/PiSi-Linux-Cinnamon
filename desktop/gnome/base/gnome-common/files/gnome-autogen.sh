...
test "$REQUIRED_AUTOCONF_VERSION" || REQUIRED_AUTOCONF_VERSION=2.69
test "$REQUIRED_AUTOMAKE_VERSION" || REQUIRED_AUTOMAKE_VERSION=1.14
...
version_check autoconf AUTOCONF 'autoconf2.50 autoconf autoconf-2.69' $REQUIRED_AUTOCONF_VERSION \
